...
- (void)makeSubviews {
    ...
    [minSliderButton setImage:[UIImage imageNamed:@"xiabashou"] forState:UIControlStateNormal];
    [minSliderButton setImage:[UIImage imageNamed:@"xiabashou"] forState:UIControlStateHighlighted];
    [minSliderButton setImage:[UIImage imageNamed:@"xiabashou"] forState:UIControlStateSelected];
    ...
    [maxSliderButton setImage:[UIImage imageNamed:@"xiabashou"] forState:UIControlStateNormal];
    [maxSliderButton setImage:[UIImage imageNamed:@"xiabashou"] forState:UIControlStateHighlighted];
    [maxSliderButton setImage:[UIImage imageNamed:@"xiabashou"] forState:UIControlStateSelected];
