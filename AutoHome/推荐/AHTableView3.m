...
- (void)tableRegister
{
    UINib * nib = [UINib nibWithNibName:@"AHFastNewsCell" bundle:nil];
    [self.table registerNib:nib forCellReuseIdentifier:@"AHFastNewsCell"];
}
...
{
    [self show];
//    self.loadData.differentPage = AHRECOMMEND2;
    __weak typeof(*&self)weakSelf = self;
...
{
    AHFastNewsCell * cell = [tableView dequeueReusableCellWithIdentifier:@"AHFastNewsCell"];
